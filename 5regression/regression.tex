...
\begin{center}
	\begin{tabular}{@{}c@{\quad\ }c@{\quad\ }c@{\quad\ }c@{}}
		\includegraphics[alt={}]{reg-rsq1}
		&
		\includegraphics[alt={}]{reg-rsq2}
		&
		\includegraphics[alt={}]{reg-rsq3}
		&
		\includegraphics[alt={}]{reg-rsq4}
		\\
		Perfect model $R^2=1$
		&
		Useless model $R^2=0$
...
\begin{minipage}[t]{0.44\linewidth}\vspace{0pt}
	\hfill\includegraphics[alt={}]{reg-line5}
	...
	\begin{enumerate}
	  ...
	  \begin{align*}
		...
		\begin{minipage}[t]{0.4\linewidth}\vspace{-12pt}
			\hfill\includegraphics[alt={}][scale=1]{reg-quad1}
		\end{minipage}
		\smallbreak
	  ...
	  \begin{enumerate}
	    ...
	    \begin{center}
	    	\begin{tabular}[t]{@{}c@{\quad}c@{\quad}c@{}}
	    		\includegraphics[alt={}]{midterm-reg1}
					&
	    		\includegraphics[alt={}]{midterm-reg2}
	    		&
	    		\includegraphics[alt={}]{midterm-reg3}
	    		\\
	    		\includegraphics[alt={}]{midterm-reg4}
	    		&
	    		\includegraphics[alt={}]{midterm-reg9}
	    		&
	    		\begin{tabular}[b]{c|c}
		    		Degree&$R^2$\\\hline
		    		1&0.4264\\
...
\begin{example*}{\ref{ex:poprabbits}, cont}{}
	...
	\begin{minipage}[t]{0.44\linewidth}\vspace{0pt}
		...
		\begin{center}
			\includegraphics[alt={}]{rabbits3}
			\qquad\qquad
			\includegraphics[alt={}]{rabbits4}
		\end{center}
		...
		\begin{minipage}[t]{0.35\linewidth}\vspace{0pt}
			\hfill\includegraphics[alt={}]{rabbits5}\\
			\includegraphics[alt={}]{rabbits6}
	\end{minipage}\medbreak
...
\hfill
\begin{minipage}[t]{0.39\linewidth}\vspace{0pt}
	\hfill\includegraphics[alt={}]{logerror}
\end{minipage}
\medbreak
	...
	\begin{enumerate}\setcounter{enumi}{1}
	  \item The table shows the average weight and length of a fish species measured at different ages.\par
		...
		\begin{minipage}[t]{0.54\linewidth}\vspace{0pt}
			\hfill\includegraphics[alt={}][scale=0.95]{fishexp}
			\vspace{-5pt}
			\begin{enumerate}
	  ...
	  \item In the early 1600s, Johannes Kepler used observational data to derive his \emph{laws of planetary motion,} the third of which relates the orbital period $T$ of a planet (how long it takes to go round the sun) to its (approximate) distance $r$ from the sun.
		...
		\begin{minipage}[t]{0.4\linewidth}\vspace{0pt}
			\hfill\includegraphics[alt={}]{kepler}
		\end{minipage}\par

...
\begin{example}{}{polar}
	A point with polar co-ordinates $\mathcolor{blue}{(r,\theta)=(2,\frac{5\pi}6)}$ has Cartesian co-ordinates
	\[
		\mathcolor{blue}{(x,y)
...
\begin{example*}[lower separated=false, sidebyside, sidebyside align=top seam, sidebyside gap=0pt, righthand width=0.35\linewidth]{\ref{ex:polar}, cont}{}
	If $\mathcolor{blue}{(x,y)=(-\sqrt 3,1)}$, then the radius is easy
	\[
	...
	\[
		...
		=\tan\left(-\frac\pi 6\right)\notimplies \theta=\mathcolor{orange}{-\frac\pi 6}
	\]
	...
	\[
		\mathcolor{blue}{\theta=\pi-\frac\pi 6=\frac{5\pi}6} =\ang{150}
	\]
	We could alternatively add any integer multiple of $2\pi$.
	\tcblower
	\hfill\includegraphics{expolar}
\end{example*}

...
\begin{minipage}[t]{0.6\linewidth}\vspace{-18pt}
...
\flushright\includegraphics[scale=0.95]{defn-radians}
\end{minipage}

\end{description}

In elementary mathematics, degrees are the most common was to measure angles. Do you know any other ways to measure angles?
...
For our purposes, the circle definition is superior because it allows us to easily consider non-acute angles and \emph{periodicity.} We can measure the polar angle counter-clockwise as many times round the origin as we like; for any integer $n$,
...
This time the initial data is ASA. Writing $\textcolor{blue}{c=5}$, $\textcolor{red}{A=\ang{40}}$ and $\textcolor{Green}{B=\ang{65}}$, the remaining angle is plainly \[\textcolor{blue}{C}=\ang{180}-\textcolor{red}{\ang{40}}-\textcolor{Green}{\ang{65}}=\textcolor{blue}{\ang{75}}\]
...
\end{minipage}\hfill\begin{minipage}[t]{0.3\linewidth}\vspace{-5pt}
...
\end{minipage}\begin{minipage}[t]{0.4\textwidth}\vspace{0pt}
...
\begin{enumerate}\setcounter{enumi}{1}
  ...
  &
  	\begin{tabular}{c}
  		...
  		$r=2\sin\theta$, \ $0\le \theta\le\pi$\\[8pt]
  		$\def\arraystretch{1.2}\begin{array}{|c|cccccc|}\hline

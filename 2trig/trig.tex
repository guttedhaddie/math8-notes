...
\begin{defn}{}{polarcoord}
	...
	\begin{enumerate}
	  \item\begin{enumerate}
	    \item Given a right triangle with \emph{hypotenuse} (longest side) 1 and angle $\theta$, define $\textcolor{blue}{\sin\theta}$ and $\textcolor{dGreen}{\cos\theta}$ to be the side lengths \emph{opposite} and \emph{adjacent} to $\theta$.\par

...
\begin{exercises}{}{}
	...
	\begin{enumerate}
	  ...
	  \item The function $y=a^x$ satisfies the natural growth equation $\diff[y]x=ky$; what is the value of $k$?
	  ...
	  \item\begin{enumerate}
		  \item Check that $y(x)=M+(y_0-M)e^{-kt}$ solves the differential equation in Corollary \ref{cor:newtoncool}.

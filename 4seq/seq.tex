...
The relationship between these results and the \emph{derivative(s)} of the original function $f(x)$ should feel intuitive: what happens if you differentiate a quadratic twice? This is yet another reason to cover this topic at grade-school level: it is getting students ready for calculus.
...
% 		\]
	...
	\hfill
	\begin{minipage}[t]{0.34\linewidth}\vspace{-10pt}
		\hfill\includegraphics{seqquadex4}
...
\begin{example}{}{}
	...
	\begin{minipage}[t]{0.6\linewidth}\vspace{0pt}
		...
		\begin{enumerate}
		  ...
		  \[
		  	\textcolor{mMagenta}{g(8)} =r_yg(6)=r_y^2g(4) =9\cdot 9= \textcolor{mMagenta}{81}
		  \]
		  \item For a power (product-product) model, $r_x=2$ corresponds to a $r_y=3$, so
		  \[
		  	\textcolor{mGreen}{g(8)} =g(2\cdot 4)=g(4r_x)=r_yg(4) =3\cdot 9 =\textcolor{mGreen}{27}
		  \]
		\end{enumerate}
	\end{minipage}
	\hfill
...
\begin{enumerate}
  ...
  \begin{minipage}[t]{0.38\linewidth}\vspace{0pt}
  	\hfill\includegraphics[]{newton-raphson}
  \end{minipage}
\end{enumerate}
...
\begin{minipage}[t]{0.34\linewidth}\vspace{0pt}
	\hfill\includegraphics{newton-raphson3}
...
\begin{examples}{}{}
	\begin{enumerate}
	  \item To find a root of $f(x)=x^4+4x-6$, start with $x_0=2$ and iterate\par
		...
		\begin{minipage}[t]{0.37\linewidth}\vspace{-8pt}
			\hfill\includegraphics[scale=0.95]{newton-raphson2}
		\end{minipage}

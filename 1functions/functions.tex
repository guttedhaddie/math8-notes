...
\includegraphics[alt={graph modeling how to knock a frisbee out of a tree}]{tree1}
\end{example}
...
\begin{exercises}{}{}
	...
	\begin{enumerate}\setcounter{enumi}{1}  
	  \item[]\begin{enumerate}
	    ...
	    \qquad\qquad
	    (b) \ $f(x)=-x^2+x+1$ %$-(x-\frac 12)^2+\frac 54$
	    \item[(c)] $f(x)=-3x^2+8x+5$ %$3(x+\frac 43)^2-\frac 13$
	  \end{enumerate}

...
\footnotetext{This is enough for our purposes, though a course in set theory will convince you that this definition has its own problems. Selection is always at work, at all levels of education\ldots}
...
\begin{examples}{}{}
	...
	\begin{enumerate}\setcounter{enumi}{1}
	  ...
	  \begin{description}
			...
			%\item[Complex numbers] $\C=\bigl\{x+iy:x,y\in\R\bigr\}$. We'll have almost no need for these.
		\end{description}

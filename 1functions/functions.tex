...
Both observations are just rephrasings of Euclid's SAS triangle similarity theorem.\footnote{%
	If two triangles have two pairs of sides in a common ratio (here $m$) and the angle between them congruent (here \ang{90}), then the triangles are similar. This result is \emph{much} older (c.\,2300 years) than the concept of graphs and equations like $f(x)=mx+c$ (400 years).}
...
\begin{example}{}{mxplusc}
	...
	\begin{minipage}[t]{0.64\linewidth}\vspace{-5pt}
		Plainly the first thing to do is to plot the given points relative to some axes, and sketch the straight line.\par

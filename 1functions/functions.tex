...
\begin{exercises}{}{}
	...
	\begin{enumerate}\setcounter{enumi}{1}
	  ...
	  \item You tell your students that a function $f$ defined by the rule $f(x)=x^2$ has domain the interval $[-5,2]$ and ask them to determine the range. You obtain various responses, including $[25,4]$, $[4,25]$, and $[-25,4]$. What is going wrong? What is the correct answer, and how would you explain it to them?
...
In this description of a line, $t=0$ corresponds to $A$ and $t=1$ to $B$. In essence, we are laying a ruler onto the line whose units correspond to the distance $\nm{AB}$.
